...
class PostSerializer(serializers.ModelSerializer):
    ...
    Requires 'request' in the serializer context to determine user-related fields.
    """
    ...
    def get_is_author(self, obj):
        request = self.context.get('request')
        return request.user.is_authenticated and request.user == obj.author if request else False
